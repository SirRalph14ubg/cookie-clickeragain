...
Game.resPath='';
if (!App && !Game.local && window.location.href.indexOf('cookieclicker.ee')!=-1)
{
	Game.resPath=('//'+location.host+location.pathname).replace('cookieclicker.ee','cookieclicker.ee');
...
Game.Launch=function()
{
	...
	'<div class="listing">'+loc("Cookie Clicker is a javascript game by %1 and %2.",['<a href="/" target="_blank">Orteil</a>','<a href="/" target="_blank">Opti</a>'])+'</div>'+
	(App?'<div class="listing">'+loc("Music by %1.",'<a href="https://twitter.com/" target="_blank">C418</a>')+'</div>':'')+
	//'<div class="listing">We have an <a href="https://discord.com/invite/Rb6NkUDwBU" target="_blank">official Discord</a>, as well as a <a href="http://forum.dashnet.org" target="_blank">forum</a>; '+
	'<div class="listing">'+(EN?
		'We have an <a href="https://discordapp.com/invite/Rb6NkUDwBU" target="_blank">official Discord</a>; if you\'re looking for help, you may also want to visit the <a href="https://www.reddit.com/" target="_blank">subreddit</a> or the <a href="https://cookieclicker.wikia.com/wiki/Cookie_Clicker_Wiki" target="_blank">wiki</a>.<br>News and teasers are usually posted on Orteil\'s <a href="https://orteil42.tumblr.com/" target="_blank">tumblr</a> and <a href="https://twitter.com/orteil42" target="_blank">twitter</a>.'
		:
		loc("Useful links: %1, %2, %3, %4.",[
		'<a href="https://discordapp.com/invite/Rb6NkUDwBU" target="_blank" class="highlightHover smallBlackButton">Discord</a>',
		]))
	+'</div>'+
	(!App?'<div class="listing block" style="margin:8px 32px;font-size:11px;line-height:110%;color:rgba(200,200,255,1);background:rgba(128,128,255,0.15);" id="supportSection">'+loc(
		...
		[(!App?'<br><br>&bull; '+(EN?'get ':'')+'<a href="https://store.steampowered.com/app/1454400/Cookie_Clicker/" target="_blank" class="highlightHover smallWhiteButton">Cookie Clicker on Steam</a>':'')+''+(EN?' (it\'s about 5 bucks)':'')+'<br><br>&bull; '+(EN?'support us on ':'')+'<a href="https://www.patreon.com/fugiman" target="_blank" class="highlightHover smallOrangeButton">Patreon</a>'+(EN?' (there\'s perks!)':'')+'<br><br>&bull; '+(EN?'check out our ':'')+'<a href="http://www.zazzle.com/store/fugiman" target="_blank" class="highlightHover smallWhiteButton">Shop</a>'+(EN?' with rad cookie shirts, hoodies and stickers':'')+((!App && EN)?'<br><br>&bull; disable your adblocker (if you want!)':'')]
	)+
	'</div></div>':'')+
	...
	'<div class="title">30/12/2024 - enhancing your cookie experience</div>'+
	'<div class="listing">&bull; added login and registration features</div>'+
	'<div class="listing">&bull; added data backup feature to save your progress to the server</div>'+
	'<div class="listing">&bull; introduced the Free Frenzy feature</div>'+
	'<div class="listing">&bull; Mac users can now use Command+S to save and Command+O to open Import save</div>'+
	'<div class="listing">&bull; improved UI for a smoother experience</div>'+
	'<div class="listing">&bull; "Clone" will now display your username when logged in</div>'+
	'<div class="listing">&bull; added 100+ new backgrounds</div>'+

	'<div class="listing">&bull; Thank you for your continued support! Enjoy these new features!</div>'+
	'</div>'+
	...
	'<div class="listing">&bull; released a low-res retro version of the game, playable here : <a href="//cookieclicker.ee/experiments/cookie/" target="_blank">cookieclicker.ee/experiments/cookie</a></div>'+
	'<div class="listing">&bull; updated version number</div>'+
	
	'</div><div class="subsection update small">'+
	'<div class="title">05/03/2019 - cookies for days</div>'+
	'<div class="listing">&bull; added over 20 new cookies, all previously suggested by our supporters on <a href="https://www.patreon.com/fugiman" target="_blank">Patreon</a></div>'+
	...
	'<div class="listing">&bull; added a new building</div>'+
	'<div class="listing">&bull; launched our <a href="https://www.patreon.com/fugiman" class="orangeLink" target="_blank">Patreon</a> <span style="font-size:80%;">(the link is orange so you\'ll notice it!)</span></div>'+
	...
	'<div class="listing">&bull; added link to <a href="https://discord.com/invite/Rb6NkUDwBU" target="_blank">official Discord server</a></div>'+
	...
	'<div class="listing">Miss the old version? Your old save was automatically exported <a href="//cookieclicker.ee/cookieclicker/v10466/" target="_blank">here</a>!</div>'+
	...
	'<div class="listing">&bull; the dungeons beta is now available on <a href="//cookieclicker.ee/cookieclicker/betadungeons" target="_blank">/betadungeons</a></div>'+
	...
	'<div class="listing">&bull; you can now <a href="//cookieclicker.ee/cookies2cash/" target="_blank">convert your cookies to cash</a>!</div>'+
	...
	'<div class="listing">&bull; don\'t forget to check out <a href="//cookieclicker.ee/randomgen/" target="_blank">RandomGen</a>, our all-purpose random generator maker!</div>'+
	...
	'<div class="listing">&bull; oh yeah, we now have <a href="http://www.zazzle.com/store/fugiman" target="_blank">Cookie Clicker shirts, stickers and hoodies</a>! (they\'re really rad)</div>'+
	...
	'<div class="listing">&bull; dungeons still need a bit more work and will be released soon - we want them to be just right! (you can test an unfinished version in <a href="//cookieclicker.ee/cookieclicker/betadungeons/" target="_blank">the beta</a>)</div>'+
	
	'</div><div class="subsection update">'+
	'<div class="title">28/09/2013 - dungeon beta</div>'+
	'<div class="listing">&bull; from now on, big updates will come through a beta stage first (you can <a href="//cookieclicker.ee/cookieclicker/betadungeons/" target="_blank">try it here</a>)</div>'+
	...
	'<div class="listing">&bull; made <a href="https://cookieclicker.ee/experiments/cookie/" target="_blank">the game</a> in a couple hours, for laughs</div>'+
	...
	Game.ErrorFrame=function()
	{
		...
		'You can <a href="//cookieclicker.ee/cookieclicker/" target="_blank">play Cookie Clicker over here</a>!<br>'+
	...
	Game.Init=function()
	{
		...
		{
			if (!App) ajax('https://blog.cookieclicker.ee/patreon/grab.php',Game.GrabDataResponse);
		...
		Game.GrabDataResponse=function(response)
		{
			...
			*/
			...
			try{
                ...
                // Use all custom grandma names, regardless of herald count
				var sponsors = Game.customGrandmaNames.slice();
				
				var sponsorsList = sponsors.length > 0 ? 'Top <a target="_blank" href="https://www.patreon.com/join/fugiman">Patreon</a> sponsors:	 ' + sponsors.join(', ') : 'No top sponsors yet';
		
				var supportComment = document.getElementsByClassName('supportComment')[0];

				if (supportComment) {
					var sponsorDiv = l('sponsor');
					if (!sponsorDiv) {
						sponsorDiv = document.createElement('div');
						sponsorDiv.id = 'sponsor';
						supportComment.appendChild(sponsorDiv);
					}
					sponsorDiv.innerHTML = '</br><marquee onmouseover="this.stop();" onmouseout="this.start();" id="vip" behavior="scroll" direction="left" scrollamount="5">' + sponsorsList + '</marquee>';
				}
		...
		if (!App)
		{
			...
			l('changeLanguage').innerHTML=loc("Language");
			l('links').childNodes[0].nodeValue=loc("Versions");
...
/*=====================================================================================
AUTHENTICATION AND BACKUP SYSTEM
=======================================================================================*/
Game.isLoggedIn = false;
Game.userData = null;
Game.autoSaveInterval = null;
Game.isAutoSaveEnabled = false;
...
Game.backupManager = {
    ...
    updateTimestamp: function(timestamp) {
        this.lastSaveAt = timestamp ? timestamp * 1000 : null;
        this.updateUI();
    },
    
    updateUI: function() {
        if (document.querySelector('.block small')) {
            document.querySelector('.block small').textContent = 
                `${loc("Last backup")}: ${this.formatTimeAgo(this.lastSaveAt)}`;
        }
    },

    formatTimeAgo: function(timestamp) {
        if (!timestamp) return loc("No backup found");
        ...
        if (seconds < 60) return loc("Just now");
        
        for (const [unit, value] of Object.entries(times)) {
            const count = Math.floor(seconds / value);
            if (count < (unit === 'minute' ? 60 : unit === 'hour' ? 24 : unit === 'day' ? 7 : unit === 'week' ? 4 : unit === 'month' ? 12 : Infinity)) {
                return count === 1 ? 
                    loc(`1 ${unit} ago`) : 
                    loc(`${count} ${unit}s ago`);
            }
        }
    }
};

Game.OpenShareBox = function() {
    // Get current URL and add ref parameter if user is logged in
    const currentUrl = window.location.href;
    const shareUrl = Game.isLoggedIn ? 
        `${currentUrl}${currentUrl.includes('?') ? '&' : '?'}ref=${Game.userData.user_id}` : 
        currentUrl;
    ...
    const shareLinks = {
        reddit: `https://www.reddit.com/submit?url=${encodedUrl}&title=${encodeURIComponent(document.title)}`,
        twitter: `https://twitter.com/intent/tweet?url=${encodedUrl}&text=${encodeURIComponent(document.title)}`,
        facebook: `https://www.facebook.com/sharer/sharer.php?u=${encodedUrl}`,
        whatsapp: `https://api.whatsapp.com/send?text=${encodedUrl}`,
        linkedin: `https://www.linkedin.com/sharing/share-offsite/?url=${encodedUrl}`,
        telegram: `https://t.me/share/url?url=${encodedUrl}&text=${encodeURIComponent(document.title)}`
    };

    Game.Prompt(`
        <div class="block">
            <h3>${loc("Share This Game")}</h3>
            <div class="line"></div>
            <p>📢 ${loc("Share with your friends!")}</p>
            <div class="line"></div>
            <small>${loc("Choose your platform to share:")} 🌐</small>
        </div>

        <div class="block">
            <div class="shareButtons">
                <a class="smallFancyButton option" 
                   onclick="window.open('${shareLinks.reddit}', '_blank', 'width=600,height=600');">
                    Reddit 🤖
                </a>
                ...
                <a class="smallFancyButton option" 
                   onclick="window.open('${shareLinks.whatsapp}', '_blank', 'width=600,height=600');">
                    WhatsApp 💬
                </a>
                ...
                <a class="smallFancyButton option" 
                   onclick="window.open('${shareLinks.telegram}', '_blank', 'width=600,height=600');">
                    Telegram ✈️
                </a>
            </div>
            <div class="line"></div>
            <small>${loc("Or copy this link:")} 🔗</small>
            <div class="copyLinkBox">
                ...
                <a class="smallFancyButton option" 
                   onclick="navigator.clipboard.writeText('${shareUrl}').then(() => {
                       Game.Notify(loc('Success'), loc('Link copied to clipboard!'), [0, 5]);
                   });">
                    ${loc("Copy Link")} 📋
                </a>
            </div>
...
Game.backupHandler = {
    async request(action, data = {}) {
        try {
            const response = await fetch('https://api.cookieclicker.ee/v2/api', {
                method: 'POST',
                credentials: 'include',
    ...
    async save() {
        if (!Game.isLoggedIn) {
            Game.Notify(loc("Please login to backup save"), '', [0, 5]);
            return false;
        }
        ...
        try {
            ...
            const data = await this.request('save', {
                save_data: Game.WriteSave(1)
            });

            if (data.success) {
                Game.Notify(loc("Game backed up successfully"), '', [10, 5]);
                Game.backupManager.updateTimestamp(data.updated_at);
				//Game.OpenAccountBox();
                return true;
            }
            throw new Error(data.message);
        } catch (error) {
            Game.Notify(loc("Connection error"), '', [0, 5]);
            return false;
        }
    },
    ...
    async restore() {
        if (!Game.isLoggedIn) {
            Game.Notify(loc("Please login to restore backup"), '', [0, 5]);
            return false;
        }

        try {
            const data = await this.request('restore');
            
            if (data.success && data.save_data && Game.LoadSave(data.save_data)) {
                Game.WriteSave();
                Game.Notify(loc("Backup restored successfully"), '', [10, 5]);
                Game.backupManager.updateTimestamp(data.updated_at);
				Game.OpenAccountBox();
                return true;
            }
            Game.Notify(loc("No backup found"), '', [0, 5]);
            return false;
        } catch (error) {
            Game.Notify(loc("Connection error"), '', [0, 5]);
            return false;
    ...
    async reset() {
        if (!Game.isLoggedIn) {
            Game.Notify(loc("Please login to reset server data"), '', [0, 5]);
            return false;
        }

        try {
            const data = await this.request('reset');
            
            if (data.success) {
                Game.Notify(loc("Server data reset complete"), '', [10, 5]);
                Game.backupManager.updateTimestamp(null);
				Game.OpenAccountBox();
                return true;
            }
            throw new Error(data.message);
...
Game.Login = function() {
    ...
    const googleLoginUrl = 'https://api.cookieclicker.ee/v2/google_login';
    ...
    window.addEventListener('message', function(event) {
        ...
        if (event.origin !== 'https://api.cookieclicker.ee') return;
        
        if (event.data.type === 'google_login') {
            if (event.data.success) {
                // Login successful
                Game.isLoggedIn = true;
                Game.userData = event.data.userData;
                Game.backupManager.updateTimestamp(event.data.last_save_at);
                Game.isAutoSaveEnabled = !!event.data.auto_save;

                if (Game.isAutoSaveEnabled) {
                    Game.startAutoSave();
                }

                Game.updateAccountButton();
                Game.Notify(loc('Success!'), `${loc("Welcome back")}, ${Game.userData.username}!`, [10, 5], 3);
                
                if (popup) popup.close();
            } else {
                // Login failed
                Game.Notify(loc("Error"), event.data.message || loc("Login failed"), [0, 5]);
            }
        }
    });
}

// Remove the old validation function since we're using Google auth now
// Game.validateAndSubmitLogin = function() { ... }
...
Game.validateAndSubmitLogin = function() {
    ...
    if (!username || !password) {
        PlaySound('snd/sell1.mp3');
        Game.Notify(loc('Error'), loc('Please fill in all fields'), [16,5]);
        return;
    }
    Game.submitLogin();
}
...
Game.Register = function() {
    Game.Prompt(`<div id="registerForm">
        <h3>${loc("Register")}</h3>
        <div class="block" style="display:flex; flex-direction:column; gap:10px; max-width:300px; margin:0 auto;">
            <input type="text" id="reg_username" placeholder="${loc("Username")}" style="padding:8px; border-radius:4px; width:auto; max-width:100%; font-size:16px;" tabindex="1" />
            <input type="password" id="reg_password" placeholder="${loc("Password")}" style="padding:8px; border-radius:4px; width:auto; max-width:100%; font-size:16px;" tabindex="2" />
            <input type="password" id="reg_confirm_password" placeholder="${loc("Confirm Password")}" style="padding:8px; border-radius:4px; width:auto; max-width:100%; font-size:16px;" tabindex="3" />
            <input type="email" id="reg_email" placeholder="${loc("Email")}" style="padding:8px; border-radius:4px; width:auto; max-width:100%; font-size:16px;" tabindex="4" />
            <a class="option focused" onclick="PlaySound('snd/tick.mp3');Game.validateAndSubmitRegister()" id="registerButton" style="margin-top:5px;" tabindex="5">${loc("Register")}</a>
        </div>
        <div class="block">
            <a href="#" onclick="PlaySound('snd/tick.mp3');Game.showLogin()">${loc("Already have an account? Login")}</a>
        </div>
    </div>`, [loc("Close")]);

    // Select all input fields in the register form
    const inputs = document.getElementById('registerForm').querySelectorAll('input');
        ...
        input.addEventListener('keydown', function(e) {
            if (e.key === 'Enter') {
                ...
                if (index < inputs.length - 1) {
                    ...
                    Game.validateAndSubmitRegister(); // Submit the form on the last input
                }
            } else if (e.key === 'Tab') {
                // Handle Tab navigation
                e.preventDefault(); // Prevent default Tab behavior
                if (e.shiftKey) {
                    // Shift + Tab: move focus to the previous input
                    if (index > 0) inputs[index - 1].focus();
                } else {
                    // Tab: move focus to the next input
...
Game.validateAndSubmitRegister = function() {
    ...
    if (password !== confirmPassword) {
        PlaySound('snd/sell1.mp3');
        Game.Notify(loc('Error'), loc('Passwords do not match'), [16,5]);
        return;
    }
    Game.submitRegister();
}
...
Game.submitLogin = async function() {
	try {
		const data = await Game.backupHandler.request('login', {
		...
		if (data.success) {
			...
			Game.backupManager.updateTimestamp(data.last_save_at);
			Game.isAutoSaveEnabled = !!data.auto_save;
 
			Game.Notify('Success!', `${loc("Welcome back")}, ${Game.userData.username}!`, [10, 5], 3);
			if (Game.isAutoSaveEnabled) {
				Game.startAutoSave();
			}
			...
			Game.Notify(loc("Error"), data.message, [0, 5]);
		}
	} catch (error) {
		Game.Notify(loc("Connection error"), '', [0, 5]);
	}
 ...
 Game.submitRegister = async function() {
	try {
		const data = await Game.backupHandler.request('register', {
			username: l('reg_username').value,
			password: l('reg_password').value,
			email: l('reg_email').value
		});
		
		if (data.success) {
			Game.Notify(loc("Registration successful! Please login."), '', [10, 5], 5);
			Game.showLogin();
		} else {
			Game.Notify(data.message || loc("Registration failed"), '', [0, 5], 5);
		}
	} catch (error) {
		Game.Notify(loc("Connection error"), '', [0, 5]);
	}
 ...
 // Account Box UI
 Game.OpenAccountBox = function() {
	if (!Game.isLoggedIn) {
		Game.Notify(loc("Error"), 'Please login first', [0, 5]);
		Game.showLogin();
		return false;
	}
	...
	Game.Prompt(`
		<div class="block">
			<h3>${loc("Account Options")}</h3>
			<div class="line"></div>
			<div style="display: flex; align-items: center; justify-content: center; gap: 10px;">
				<span>🖐️✨ ${loc("Hi")}, ${Game.userData.username}</span>
				${Game.userData.avatar_url ? `<img src="${Game.userData.avatar_url}" alt="Avatar" style="width: 40px; height: 40px; border-radius: 50%; object-fit: cover;">` : ''}

			</div>
			<div class="line"></div>
			<small>${loc("Stop losing data when switching devices or browsers. Back it up to the cloud!")} ☁️</small>
		</div>
 
		<div class="block">
			<a id="autoBackupButton" 
			   class="smallFancyButton prefButton option" 
			   onclick="Game.toggleAutoSave(!Game.isAutoSaveEnabled); PlaySound('snd/tick.mp3');">
				${Game.isAutoSaveEnabled ? 'Auto backup ON' : 'Auto backup OFF'}
			</a>
			<div class="line"></div>
			<small>${loc("Automatically back up your progress every 5 minutes.")}</small>
			<div class="line"></div>
			<a class="option smallFancyButton" onclick="Game.OpenShareBox();">${loc("Share")}</a>
			<div class="line"></div>
			
		</div>
 
		<div class="block">
		<small>${loc("Last backup")}: ${Game.backupManager.formatTimeAgo(Game.backupManager.lastSaveAt)}</small>
		<div class="line"></div>
			<a class="option smallFancyButton" onclick="Game.confirmBackup();">${loc("Back Up to Server")}</a>
			<br>
			
			<a class="option smallFancyButton" onclick="Game.confirmRestore();">${loc("Restore from Server")}</a>
			<br>
			<a class="option smallFancyButton warning" onclick="Game.confirmReset();">${loc("Reset Server Data")}</a>
			<div class="line"></div>
			
			<a class="option smallFancyButton" style="padding:4px;" onclick="Game.logout(); Game.ClosePrompt();">${loc("Logout")}</a>
		</div>
	`, [loc("Close")]);
 }
 
 // Button Updates
 Game.updateAccountButton = function() {
	const accBtn = l('accBtn');

	Game.updateAutoSaveBtn();
	
	if (!accBtn) return;


	const tooltipTextForLoginBtn = Game.isLoggedIn 
		? "View your account menu."
		: "Log in or Register an account for a better experience.";

	
	Game.attachTooltip(
		l('accBtn'),
		`<div style="padding:8px;width:350px;text-align:center;font-size:11px;">${tooltipTextForLoginBtn}</div>`,
		'this'
	);
...
if (Game.isLoggedIn && Game.userData) {
    accBtn.innerHTML = `
        <div style="position:relative;display:inline-block;vertical-align:middle;margin-top:-2px;">
            ${Game.userData.avatar_url ? 
                `<img src="${Game.userData.avatar_url}" alt="${Game.userData.username}" style="width:20px;height:20px;border-radius:50%;">` :
                DEFAULT_AVATAR_SVG
            }
        </div>
    ...
    accBtn.onclick = () => {
        PlaySound('snd/clickOn2.mp3');
        accBtn.href = "https://api.cookieclicker.ee/v2/google_login";
    };
}
 }
 // Auto-save System
Game.updateAutoSaveBtn = function() {
	if (!Game.autoSaveIcon) return;
 
	const isEnabled = Game.isAutoSaveEnabled;
	Game.autoSaveIcon.classList.toggle('enabled', isEnabled);
	
	const tooltipText = isEnabled 
		? "Your game progress is being automatically saved to the server every <b>5 minutes</b>."
		: "Auto-save is currently <b>disabled</b>. Your progress will not be automatically saved.";
	
	Game.attachTooltip(
		l('autoSaveIcon'),
		`<div style="padding:8px;width:350px;text-align:center;font-size:11px;">${tooltipText}</div>`,
		'this'
	);
 ...
 Game.startAutoSave = function() {
	console.log("Auto back up started!")
	Game.stopAutoSave();
	
	if (Game.isLoggedIn && Game.userData && Game.isAutoSaveEnabled) {
		Game.autoSaveInterval = setInterval(() => {
			if (Game.isLoggedIn && Game.isAutoSaveEnabled) {
				Game.backupHandler.save();
			}
		}, 5 * 60 * 1000);
	}
 }
 
 Game.stopAutoSave = function() {
 ...
 Game.toggleAutoSave = async function(enable) {
	if (!Game.isLoggedIn || !Game.userData) return;
 
	try {
		const data = await Game.backupHandler.request('save_settings', {
			auto_save: enable
		});
 
		if (data.success) {
			Game.isAutoSaveEnabled = enable;
			
			Game.stopAutoSave();
			if (enable) {
				Game.startAutoSave();
				Game.Notify(loc("Enabled"), loc("Auto backup game progress to server enabled"), [10, 5], 30);
			} else {
				Game.Notify(loc("Disabled"), loc("Auto backup game progress to server disabled"), [0, 5], 30);
			}
 
			l('autoBackupButton').innerHTML = enable ? 'Auto backup ON' : 'Auto backup OFF';
			Game.updateAutoSaveBtn();
		}
	} catch (error) {
 ...
 Game.confirmBackup = function() {
	Game.Prompt(`
		<div class="block" style="text-align:center;padding:8px;color:#f44336;">
			<h3 style="color:#f44336;">${loc("Warning")}</h3>
			<p style="font-size:14px;">${loc("This will back up your data to the server, replacing the previous save.")}</p>
			<p style="font-size:14px;">${loc("Are you sure you want to proceed?")}</p>
			<a class="option bigButton" onclick="Game.backupHandler.save();">${loc("Yes, Backup")}</a>
			<a class="option bigButton" onclick="Game.OpenAccountBox();">${loc("Back")}</a>
		</div>
	`, [loc("Cancel")]);
 }
 
 Game.confirmRestore = function() {
	Game.Prompt(`
		<div class="block" style="text-align:center;padding:8px;color:#f44336;">
			<h3 style="color:#f44336;">${loc("Warning")}</h3>
			<p style="font-size:14px;">${loc("This will replace the current data with the data stored on the server.")}</p>
			<p style="font-size:14px;">${loc("Are you sure you want to proceed?")}</p>
			<a class="option bigButton" onclick="Game.backupHandler.restore();">${loc("Yes, Restore")}</a>
			<a class="option bigButton" onclick="Game.OpenAccountBox();">${loc("Back")}</a>
		</div>
	`, [loc("Cancel")]);
 }
 ...
 Game.confirmReset = function() {
	Game.Prompt(`
		<div class="block" style="text-align:center;padding:8px;color:#f44336;">
			<h3 style="color:#f44336;">${loc("Warning")}</h3>
			<p style="font-size:14px;">${loc("This action will permanently delete all server data.")}</p>
			<p style="font-size:14px;">${loc("Are you sure you want to proceed?")}</p>
			<a class="option bigButton" onclick="Game.backupHandler.reset();">${loc("Yes, Reset")}</a>
			<a class="option bigButton" onclick="Game.OpenAccountBox();">${loc("Back")}</a>
		</div>
	`, [loc("Cancel")]);
 }
 ...
 // Session Management
Game.checkSession = async function() {
	try {
		const data = await Game.backupHandler.request('check_session');
 ...
 Game.logout = async function() {
	try {
		const data = await Game.backupHandler.request('logout');
		...
		if (data.success) {
			...
			Game.isAutoSaveEnabled = false;
			Game.updateAccountButton();
			Game.Notify(loc("Logged out successfully"), '', [10, 5], 1);
		}
	} catch (error) {
		console.error('Logout error:', error);
		Game.Notify(loc("Error logging out"), '', [0, 5], 1);
	}
 }
 
 Game.makeAutoSaveIcon = function() {
    const autoSaveIcon = document.createElement('div');
    autoSaveIcon.id = 'autoSaveIcon';
	autoSaveIcon.onclick = function() {
        Game.OpenAccountBox();
    };
    autoSaveIcon.style.cssText = 'cursor:pointer;display:inline-block;position:relative;top:4px;left:0px;margin:0px 4px;';
    ...
    style.textContent = `
        ...
        #autoSaveIcon.enabled svg {
            color: #4CAF50;
            filter: drop-shadow(0px 1px 2px rgba(76,175,80,0.3));
        }
    `;
    
    svg.appendChild(path);
    autoSaveIcon.appendChild(svg);
    document.head.appendChild(style);
    
    const httpsSwitch = document.getElementById('httpsSwitch');
    if (httpsSwitch?.parentNode) {
        httpsSwitch.parentNode.insertBefore(autoSaveIcon, httpsSwitch.nextSibling);
    }
 ...
 // Utility Functions
 Game.showLogin = () => Game.Login();
 Game.showRegister = () => Game.Register();
 
 // Direct API wrappers
 Game.saveGameToServer = () => Game.backupHandler.save();
 Game.restoreFromServer = () => Game.backupHandler.restore();
 Game.resetServerData = () => Game.backupHandler.reset();
 
 // Initialize
 Game.checkSession();
 Game.autoSaveIcon = Game.makeAutoSaveIcon();
		...
		AddEvent(window,'keydown',function(e){
			...
			if (!Game.OnAscend && Game.AscendTimer==0)
				{
					// Check for both Ctrl and Command key (metaKey for Mac)
					if ((e.ctrlKey || e.metaKey) && e.keyCode==83) {
						Game.toSave=true;
						e.preventDefault();
					} //ctrl/cmd-s saves the game
					else if ((e.ctrlKey || e.metaKey) && e.keyCode==79) {
						Game.ImportSave();
						e.preventDefault();
					} //ctrl/cmd-o opens the import menu
				}
					...
					*/
					...
					for (var i=0;i<len;i++)
					{
						...
						if (selected==i && this.name=='You')
						{
							...
							ctx.font='9px Merriweather';
							ctx.textAlign='center';
							var text = (Game.userData && Game.userData.username ? Game.userData.username : loc("Clone")) 
           + ' #' + Math.floor(Math.random() * 500 + pic.id * 500 + 1);
							if (EN)
							{
								text=[
									text,
				...
				if (this.choicesFunction)
					{
						...
						else
						{
							...
							else if (choices.length>0)
							{
								...
								// Calculate if scrollbar needed (assuming each item height is 64px + some margin)
								var itemHeight = 64; // Item height in pixels
								var maxVisibleItems = 5; // Number of items that can fit without scroll
								var maxHeight = itemHeight * maxVisibleItems;
								var totalHeight = choices.length * itemHeight;
								var needScroll = totalHeight > maxHeight;
								
								str+='<div id="bgScroller" style="max-height:'+maxHeight+'px;'+(needScroll ? 'overflow-y:auto;' : 'overflow-y:hidden;')+'padding-right:'+(needScroll ? '5px' : '0')+'; scroll-behavior:auto;">';
								...
								for (var i = 0; i < choices.length; i++) {
									...
									var id = choices[i].id;
									var isPro = choices[i].name.includes("Pro");
								
									// Add the name overlay only for items containing "Pro"
									var nameOverlay = isPro
										? '<div style="position:absolute;top:50%;left:50%;transform:translate(-50%,-50%);color:gold!important;font-size:14px;font-weight:bold;text-shadow:1px 1px 2px black;font-family:Georgia,serif;">' + choices[i].name + '</div>'
										: '';
								
									// Apply grayscale effect only for "Pro" items
									var iconStyle = isPro ? 'filter:grayscale(100%);' : '';
								
									if (choices[i].div) str += '<div class="line"></div>';
									str += '<div id="bg_' + id + '" class="crate noFrame enabled' + (id == selected ? ' highlighted' : '') + '" style="opacity:1;float:none;display:inline-block;position:relative;' + iconStyle + writeIcon(icon) + '" ' + Game.clickStr + '="Game.UpgradesById[' + this.id + '].choicesPick(' + id + ');Game.choiceSelectorOn=-1;Game.UpgradesById[' + this.id + '].buy();" onMouseOut="l(\'choiceSelectedName\').innerHTML=Game.choiceSelectorChoices[Game.choiceSelectorSelected].name;" onMouseOver="l(\'choiceSelectedName\').innerHTML=Game.choiceSelectorChoices[' + i + '].name;">';
								
									// Add the name overlay for items containing "Pro"
									if (nameOverlay) {
										str += nameOverlay;
									}
							...
							var selectedBg = l('bg_'+selected);
							if(selectedBg) {
								l('bgScroller').scrollTop = selectedBg.offsetTop - l('bgScroller').offsetHeight/2 + selectedBg.offsetHeight/2;
							}
		...
		Game.AllBGs=[
			...
			{pic:'bgMoon',name:'Pro 1',icon:[24,21]},
			{pic:'bgMoon2',name:'Pro 2',icon:[24,21]},
			{pic:'bgMoon3',name:'Pro 3',icon:[24,21]},
			{pic:'bgMoon4',name:'Pro 4',icon:[24,21]},
			{pic:'bgMoon5',name:'Pro 5',icon:[24,21]},
			{pic:'bgMoon6',name:'Pro 6',icon:[24,21]},
			{pic:'bgMoon7',name:'Pro 7',icon:[24,21]},
			{pic:'bgMoon8',name:'Pro 8',icon:[24,21]},
			{pic:'bgMoon9',name:'Pro 9',icon:[24,21]},
			{pic:'bgMoon10',name:'Pro 10',icon:[24,21]},
			{pic:'bgMoon11',name:'Pro 11',icon:[24,21]},
			{pic:'bgMoon12',name:'Pro 12',icon:[24,21]},
			{pic:'bgMoon14',name:'Pro 14',icon:[24,21]},
			{pic:'bgMoon16',name:'Pro 16',icon:[24,21]},
			{pic:'bgMoon17',name:'Pro 17',icon:[24,21]},
			{pic:'bgMoon18',name:'Pro 18',icon:[24,21]},
			{pic:'bgMoon19',name:'Pro 19',icon:[24,21]},
			{pic:'bgMoon20',name:'Pro 20',icon:[24,21]},
			{pic:'bgMoon22',name:'Pro 22',icon:[24,21]},
			{pic:'bgMoon23',name:'Pro 23',icon:[24,21]},
			{pic:'bgMoon24',name:'Pro 24',icon:[24,21]},
			{pic:'bgMoon25',name:'Pro 25',icon:[24,21]},
			{pic:'bgMoon26',name:'Pro 26',icon:[24,21]},
			{pic:'bgMoon27',name:'Pro 27',icon:[24,21]},
			{pic:'bgMoon28',name:'Pro 28',icon:[24,21]},
			{pic:'bgMoon29',name:'Pro 29',icon:[24,21]},
			{pic:'bgMoon30',name:'Pro 30',icon:[24,21]},
			{pic:'bgMoon31',name:'Pro 31',icon:[24,21]},
			{pic:'bgMoon32',name:'Pro 32',icon:[24,21]},
			{pic:'bgMoon34',name:'Pro 34',icon:[24,21]},
			{pic:'bgMoon35',name:'Pro 35',icon:[24,21]},
			{pic:'bgMoon36',name:'Pro 36',icon:[24,21]},
			{pic:'bgMoon37',name:'Pro 37',icon:[24,21]},
			{pic:'bgMoon38',name:'Pro 38',icon:[24,21]},
			{pic:'bgMoon39',name:'Pro 39',icon:[24,21]},
			{pic:'bgMoon40',name:'Pro 40',icon:[24,21]},
			{pic:'bgMoon41',name:'Pro 41',icon:[24,21]},
			{pic:'bgMoon42',name:'Pro 42',icon:[24,21]},
			{pic:'bgMoon43',name:'Pro 43',icon:[24,21]},
			{pic:'bgMoon44',name:'Pro 44',icon:[24,21]},
			{pic:'bgMoon45',name:'Pro 45',icon:[24,21]},
			{pic:'bgMoon46',name:'Pro 46',icon:[24,21]},
			{pic:'bgMoon47',name:'Pro 47',icon:[24,21]},
			{pic:'bgMoon48',name:'Pro 48',icon:[24,21]},
			{pic:'bgMoon49',name:'Pro 49',icon:[24,21]},
			{pic:'bgMoon50',name:'Pro 50',icon:[24,21]}, 
{pic:'bgMoon51',name:'Pro 51',icon:[24,21]}, 
{pic:'bgMoon52',name:'Pro 52',icon:[24,21]}, 
{pic:'bgMoon53',name:'Pro 53',icon:[24,21]}, 
{pic:'bgMoon54',name:'Pro 54',icon:[24,21]}, 
{pic:'bgMoon55',name:'Pro 55',icon:[24,21]}, 
{pic:'bgMoon56',name:'Pro 56',icon:[24,21]}, 
{pic:'bgMoon57',name:'Pro 57',icon:[24,21]}, 
{pic:'bgMoon58',name:'Pro 58',icon:[24,21]}, 
{pic:'bgMoon59',name:'Pro 59',icon:[24,21]}, 
{pic:'bgMoon60',name:'Pro 60',icon:[24,21]}, 
{pic:'bgMoon61',name:'Pro 61',icon:[24,21]}, 
{pic:'bgMoon62',name:'Pro 62',icon:[24,21]}, 
{pic:'bgMoon63',name:'Pro 63',icon:[24,21]}, 
{pic:'bgMoon64',name:'Pro 64',icon:[24,21]}, 
{pic:'bgMoon65',name:'Pro 65',icon:[24,21]}, 
{pic:'bgMoon66',name:'Pro 66',icon:[24,21]}, 
{pic:'bgMoon67',name:'Pro 67',icon:[24,21]}, 
{pic:'bgMoon68',name:'Pro 68',icon:[24,21]}, 
{pic:'bgMoon69',name:'Pro 69',icon:[24,21]}, 
{pic:'bgMoon70',name:'Pro 70',icon:[24,21]}, 
{pic:'bgMoon71',name:'Pro 71',icon:[24,21]}, 
{pic:'bgMoon72',name:'Pro 72',icon:[24,21]}, 
{pic:'bgMoon73',name:'Pro 73',icon:[24,21]}, 
{pic:'bgMoon74',name:'Pro 74',icon:[24,21]}, 
{pic:'bgMoon75',name:'Pro 75',icon:[24,21]}, 
{pic:'bgMoon76',name:'Pro 76',icon:[24,21]}, 
{pic:'bgMoon77',name:'Pro 77',icon:[24,21]}, 
{pic:'bgMoon78',name:'Pro 78',icon:[24,21]}, 
{pic:'bgMoon79',name:'Pro 79',icon:[24,21]}, 
{pic:'bgMoon80',name:'Pro 80',icon:[24,21]}, 
{pic:'bgMoon81',name:'Pro 81',icon:[24,21]}, 
{pic:'bgMoon82',name:'Pro 82',icon:[24,21]}, 
{pic:'bgMoon83',name:'Pro 83',icon:[24,21]}, 
{pic:'bgMoon84',name:'Pro 84',icon:[24,21]}, 
{pic:'bgMoon85',name:'Pro 85',icon:[24,21]}, 
{pic:'bgMoon86',name:'Pro 86',icon:[24,21]}, 
{pic:'bgMoon87',name:'Pro 87',icon:[24,21]}, 
{pic:'bgMoon88',name:'Pro 88',icon:[24,21]}, 
{pic:'bgMoon89',name:'Pro 89',icon:[24,21]}, 
{pic:'bgMoon90',name:'Pro 90',icon:[24,21]}, 
{pic:'bgMoon91',name:'Pro 91',icon:[24,21]}, 
{pic:'bgMoon92',name:'Pro 92',icon:[24,21]}, 
{pic:'bgMoon93',name:'Pro 93',icon:[24,21]}, 
{pic:'bgMoon94',name:'Pro 94',icon:[24,21]}, 
{pic:'bgMoon95',name:'Pro 95',icon:[24,21]}, 
{pic:'bgMoon96',name:'Pro 96',icon:[24,21]}, 
{pic:'bgMoon97',name:'Pro 97',icon:[24,21]}, 
{pic:'bgMoon98',name:'Pro 98',icon:[24,21]}, 
{pic:'bgMoon99',name:'Pro 99',icon:[24,21]}, 
{pic:'bgMoon100',name:'Pro 100',icon:[24,21]}, 
{pic:'bgMoon101',name:'Pro 101',icon:[24,21]},
{pic:'bgMoon102',name:'Pro 102',icon:[24,21]},
{pic:'bgMoon103',name:'Pro 103',icon:[24,21]},
{pic:'bgMoon104',name:'Pro 104',icon:[24,21]},
{pic:'bgMoon105',name:'Pro 105',icon:[24,21]},
{pic:'bgMoon106',name:'Pro 106',icon:[24,21]},
{pic:'bgMoon107',name:'Pro 107',icon:[24,21]},
{pic:'bgMoon108',name:'Pro 108',icon:[24,21]},
{pic:'bgMoon109',name:'Pro 109',icon:[24,21]},
{pic:'bgMoon110',name:'Pro 110',icon:[24,21]},
		...
		Game.TieredUpgrade('Nested','<q>Clever self-reference or shameful cross-promotion? This upgrade apparently has the gall to advertise a link to <u>cookieclicker.ee/nested</u>, in a tooltip you can\'t even click.</q>','Fractal engine',8);
